...
from .models import CMult, Pyke,FMult, DistMult, KeciBase, Keci,NAS,Polynomial, TransE,FMult2, \
    ComplEx,ComplexNumber, AConEx, AConvO, AConvQ, ConvQ, ConvO, ConEx, QMult, OMult, Shallom
...
def intialize_model(args: dict) -> Tuple[object, str]:
    ...
    if "pykeen" in model_name.lower():
        ...
        model = Polynomial(args=args)
        form_of_labelling = 'EntityPrediction'
    elif model_name == 'ComplexNumber':
        model = ComplexNumber(args=args)
        form_of_labelling = 'EntityPrediction'
